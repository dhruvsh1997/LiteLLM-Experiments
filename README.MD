...
gantt
    ...
    section Upcoming
    Advanced RAG           :active, exp4, 2024-04-01, 2024-04-30
    Fine-tuning Tests      :exp5, 2024-05-01, 2024-05-31
...
pip install litellm ragas langchain chromadb sentence-transformers matplotlib pandas numpy
```
